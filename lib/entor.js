 ...
 * @property {string} sharedEnvPath Default `undefined`. The **absolute path** to the shared environment folder path from the root. With `envType = "local"` Entor will search for `local.shared.entor.json`.
 ...
 * @property {boolean} syncExamples Default `false`. If `true` syncs the `entor.<envType>.json` file with the `entorExample.<envType>.json` file.
 * 
*/
...
function entor({
	...
	let archivo = `entor.${envType}.json`;
